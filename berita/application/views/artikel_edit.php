...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">Artikel</h2>
					<?php
					foreach ($artikel as $row){
						?>
						<form method="post" action="<?php echo site_url('Artikel/edit?id='. $this->uri->segment(3));?>" enctype="multipart/form-data">

						<div class="form-group">
								<label for="usr">Judul:</label>
								<input type="text" class="form-control" name="in_judul" required="" value="<?php echo $row->judul;?>">
							</div>
							<div class="form-group">
								<label for="usr">Kategori:</label>
								<select name="in_kategori" value="<?php echo $row->kategori;?>" class="form-control">
							...
							<div class="form-group">
								<img src="<?php echo base_url();?>assets/images/<?php echo $row->gambar;?>" style="width: 80px">
							</div>
