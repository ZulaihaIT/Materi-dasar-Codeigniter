...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Default Blog</li>
        </ol>
    </nav>
    <!-- //breadcrumbs -->
    <!-- blog -->
    <div class="container">
        ...
        <div class="blog-mid-sec py-sm-5">
            ...
            <ul id="flexiselDemo2">
                <li>
                    <div class="blog-item">
                        <img src="<?php echo base_url('assets/')?>images/g5.jpg" alt=" " class="img-fluid" />
                ...
                <li>
                    <div class="blog-item">
                        <img src="<?php echo base_url('assets/')?>images/g6.jpg" alt=" " class="img-fluid" />
                        <div class="floods-text">
                            <h3>
                                <a href="single.html">The fed and inequality
                                    <span>Blogger |
                ...
                <li>
                    <div class="blog-item">
                        <img src="<?php echo base_url('assets/')?>images/g7.jpg" alt=" " class="img-fluid" />
                        <div class="floods-text">
                            <h3>
                                <a href="single.html">The fed and inequality
                                    <span>Blogger |
                ...
                <li>
                    <div class="blog-item">
                        <img src="<?php echo base_url('assets/')?>images/g8.jpg" alt=" " class="img-fluid" />
                        <div class="floods-text">
                            <h3>
                                <a href="single.html">The fed and inequality
                                    <span>Blogger |
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-lg-6 my-lg-0 my-5">
                                <div class="card">
                                    <img class="img-fluid" src="http://localhost/berita/assets/images/<?php echo $row->gambar?>"  alt="">
                                    <div class="card-body">
                                        <div class="news-title">
                                            <a href="single.html">
                                                <h4 class="title-small"><?php echo $row->judul?></h4>
                                            </a>
                                        </div>
                                        <p class="card-text"><?php echo $row->deskripsi?></p>
                                        <p class="card-text">
                                            <small class="text-time">
                                                <em><?php echo $row->kategori?></em>
                                            </small>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <aside class="col-lg-4 side-bar col-md-12 mt-sm-5">
                        ...
                        <div class="tab-content sidebar-tabing mt-3" id="nav-tabContent">
                            <div class="tab-pane active" id="home" role="tabpanel">
                                <div class="media">
                                    <a href="single.html">
                                        <img class="d-flex mr-3 img-fluid" src="<?php echo base_url('assets/')?>images/g5.jpg" alt="Generic placeholder image" />
                                    </a>
                                ...
                                <div class="media">
                                    <a href="single.html">
                                        <img class="d-flex mr-3 img-fluid" src="<?php echo base_url('assets/')?>images/g7.jpg" alt="Generic placeholder image" />
                                    </a>
                                    <div class="media-body">
                                        <div class="news-title">
                                            <h4 class="title-small">
                                ...
                                <div class="media">
                                    <a href="single.html">
                                        <img class="d-flex mr-3 img-fluid" src="<?php echo base_url('assets/')?>images/g2.jpg" alt="Generic placeholder image" />
                                    </a>
                                    <div class="media-body">
                                        <div class="news-title">
                                            <h4 class="title-small">
                            ...
                            <div class="tab-pane" id="profile" role="tabpanel">
                                ...
                                <div class="media">
                                    <a href="single.html">
                                        <img class="d-flex mr-3 img-fluid" src="<?php echo base_url('assets/')?>images/g4.jpg" alt="Generic placeholder image" />
                                    </a>
                                    <div class="media-body">
                                        <div class="news-title">
                                            <h4 class="title-small">
                            ...
                            <div class="tab-pane" id="messages" role="tabpanel">
                                ...
                                <div class="media">
                                    <a href="single.html">
                                        <img class="d-flex mr-3 img-fluid" src="<?php echo base_url('assets/')?>images/g1.jpg" alt="Generic placeholder image">
                                    </a>
                                    <div class="media-body">
                                        <div class="news-title">
                                            <h4 class="title-small">
    ...
    <script src="<?php echo base_url() ?>assets/js/Beautyblog.js"></script>
    <!-- smooth scroll -->
